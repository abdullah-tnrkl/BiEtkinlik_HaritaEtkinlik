...
////                        Toast.makeText(AppActivity.this, "Profil fotoğrafınız eklendi...", Toast.LENGTH_SHORT).show();
////                    }
////                }
////            });
//            dRef.child("Activitys").child(UserId).child("photo").setValue(String.valueOf(uri));
//        }
//    });
//}
    @Override
